...
3. [Layer 1: GitHub Copilot SDK](#layer-1-github-copilot-sdk--the-extensibility-foundation)
4. [Layer 2: GitHub Copilot CLI](#layer-2-github-copilot-cli--the-user-interface)
5. [Layer 3: AKS MCP Server](#layer-3-aks-model-context-protocol-mcp-server)
